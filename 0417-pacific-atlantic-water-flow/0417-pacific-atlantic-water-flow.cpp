...
public:
    vector<vector<int>> pacificAtlantic(vector<vector<int>>& heights) {
        ...
        // Lost Point #1. Check if input is empty
        if (m == 0 || n == 0) return h;
    ...
    // Lost Point #4. Please get result!
    vector<vector<bool>> bfs(queue<pair<int, int>> q) {
        ...
        while (!q.empty()) {
            ...
            // Lost Point #2. Mark this cell reachable
            b_arr[row][col] = true;
            ...
            for (int i = 0; i < 4; i++) {
                ...
                // Lost Point #3. Already marked cell
                if (b_arr[r][c] == true)
                    continue;
                ...
                //b_arr[r][c] = true; Lost Point #4. Move marking place
                q.push(make_pair(r, c));
            }
        }

        return b_arr; // Lost Point #4. Please get result!
    }
};